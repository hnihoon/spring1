...
<hr>
<a href="./">현재 프로젝트 경로(컨텍스트)의 url http://localhost:8085/app/</a><br>
<a href="test">http://localhost:8085/app/test</a><br>
<a href="hello">http://localhost:8085/app/hello</a><br>
<a href="spring">http://localhost:8085/app/spring</a>
<h5>파라미터 테스트</h5>
<a href="search?name=모모&age=22">http:localhost:8085/app/search?name=모모&age=22</a><br>
<a href="search?name=모모">http:localhost:8085/app/search?name=모모</a><br>
